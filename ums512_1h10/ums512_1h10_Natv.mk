...
#limit background camera 5~10fps
PRODUCT_PROPERTY_OVERRIDES += persist.vendor.cam.multi.fps.limit.bg=1005
...
PRODUCT_PROPERTY_OVERRIDES += persist.vendor.cam.video.face.beauty.enable=0
#enable fov fusion
PRODUCT_PROPERTY_OVERRIDES += persist.vendor.cam.fov.fusion.enable=0
