...
export KERNEL_PATH
$(call inherit-product, device/sprd/sharkl5Pro/ums512_2h10/ums512_2h10_Base.mk)
PLATDIR := device/sprd/sharkl5Pro
TARGET_BOARD := ums512_2h10
...
TARGET_BOOTLOADER_BOARD_NAME := ums512_2h10
CHIPRAM_DEFCONFIG := ums512_2h10
UBOOT_DEFCONFIG := ums512_2h10
UBOOT_TARGET_DTB := ums512_2h10

PRODUCT_NAME := ums512_2h10_Natv
PRODUCT_DEVICE := ums512_2h10
PRODUCT_BRAND := SPRD
PRODUCT_MODEL := ums512_2h10_Natv
...
PRODUCT_COPY_FILES += \
    $(BOARDDIR)/ums512_2h10.xml:$(PRODUCT_OUT)/ums512_2h10.xml
